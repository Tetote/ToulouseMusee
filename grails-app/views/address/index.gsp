		...
		<div id="list-address" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="num" title="${message(code: 'address.num.label', default: 'Num')}" />
				...
				<g:each in="${addressInstanceList}" status="i" var="addressInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${addressInstance.id}">${fieldValue(bean: addressInstance, field: "num")}</g:link></td>
